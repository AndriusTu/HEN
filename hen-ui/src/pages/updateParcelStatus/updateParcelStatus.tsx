...
import parcelDetailsMock, {StatusHistory} from "../../mocks/parcelDetailsMock";
    ...
    return (
        ...
        <div className="w-full">
            ...
            <div className="row bg-gray_100 p-3.5 rounded-[20px] w-full parcel" >
                ...
                <div className="parcelRowElement" style={{verticalAlign:'top'}}>
                    <div
                         style={{verticalAlign:'top'}}>
                        Parcel
                        <Text
                ...
                <div className="parcelRowElement mb-3" style={{verticalAlign:'top'}}>
                    ...
                    <div className="parcelRowElement">
                        <div className="">
                            ...
                            <Text
                                ...
                                variant="h5"
                            >
                                {parcelDetailsMock.receiver.name} {parcelDetailsMock.receiver.surname}
                            </Text>
                            <div className="mt-4">
                                ...
                                <Text
                                    ...
                                    variant="h5"
                                >
                                    {parcelDetailsMock.receiver.address.street.toString().concat(' ', parcelDetailsMock.receiver.address.city)}
                                </Text>
                                <Text
                                    className="font-normal not-italic text-bluegray_400 text-left w-auto row mt-4"
                                    as="h5"
                        ...
                        <div//HEADER
                            ...
                            <div className="flex flex-row mt-4 max-w-fit">
                                <div className="basis-1/2 md:basis-1/3 mr-5">
                                    ...
                                    <Select className="text-ellipsis w-[150px]"
                                        options={options}
                                        placeholder="Status"/>
                                </div>
                                <div className="basis-1/2 md:basis-1/3 w-[150px]">
                                    <Select className="text-ellipsis"
                                        options={options}
